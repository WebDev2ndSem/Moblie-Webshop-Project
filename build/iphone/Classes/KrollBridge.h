...
@interface Exercise2Object : KrollCoverageObject {
#else
@interface Exercise2Object : KrollObject {
#endif
@private
...
extern NSString * Exercise2$ModuleRequireFormat;
