...
// in simulator we redefine to format for Exercise2 Developer console
...
{\
	NSString * exceptionName = [@"org.exercise2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.exercise2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIExercise2NativeItemNone = -1, 
	UIExercise2NativeItemSpinner = -2,
	UIExercise2NativeItemProgressBar = -3,
	
	UIExercise2NativeItemSlider = -4,
	UIExercise2NativeItemSwitch = -5,
	UIExercise2NativeItemMultiButton = -6,
	UIExercise2NativeItemSegmented = -7,
	
	UIExercise2NativeItemTextView = -8,
	UIExercise2NativeItemTextField = -9,
	UIExercise2NativeItemSearchBar = -10,
	
	UIExercise2NativeItemPicker = -11,
	UIExercise2NativeItemDatePicker = -12,
	
	UIExercise2NativeItemInfoLight = -13,
	UIExercise2NativeItemInfoDark = -14,
	
	UIExercise2NativeItemDisclosure = -15,
	
	UIExercise2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Exercise2 instances of
