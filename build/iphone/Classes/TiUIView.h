...
/**
 Base class for all Exercise2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Exercise2 view hierarchy (such as wrapped iOS UIViews) was touched.
