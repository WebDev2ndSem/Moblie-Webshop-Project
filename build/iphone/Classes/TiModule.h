...
/**
 The base class for all Exercise2 modules
 */
...
/**
 Exercise2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Exercise2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Exercise2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Exercise2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Exercise2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
